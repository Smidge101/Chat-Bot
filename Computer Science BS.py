...
def main():
    ...
    file_path = "C:\\Users\\Tyrique\\Downloads\\Comp Sci stuff\\325\\cs325_quiz2\\Chat-Bot\\Sample curriculum for Bachelors of Science in Computer Science.txt"  # Replace with your .txt file path
